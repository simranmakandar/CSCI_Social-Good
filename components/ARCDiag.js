...
.range([1,10]);
  ...
  var links = svg
    ...
    .append("text")
      ...
      .on('mouseover', function (i,d) {
         var str = "Details (hover over the nodes)\n";
  ...
  return (
    <div>
        <div className ="title">
            <h3>Arc Diagram</h3>
            <p>A new d3 layout indicating covid cases as the size of circle for every region 
              and the width of arcs connecting other regions indicates number of flights exchange between two regions. 
            </p>       
        </div>
